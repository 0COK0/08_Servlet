...
<form action="querystring" method="get">
    ...
    <br>
    <label>취미 : </label>
    <input type="checkbox" name="hobbies" id="novie" value="novie"><label for="novie">영화</label>>
...
<a href="querystring?name=곽도팔&age=11&birthday=2024-04-01&gender=M&national=etc&hobbies=novie">
    쿼리스트링을 이용한 값 전달</a>
...
<form action="formdata" method="post">
    ...
    <br>
    <label>취미 : </label>
    <input type="checkbox" name="hobbies" id="novie2" value="novie2"><label for="novie">영화</label>>
    <input type="checkbox" name="hobbies" id="music2" value="music2"><label for="music">음악</label>>
